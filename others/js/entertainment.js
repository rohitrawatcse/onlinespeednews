...
xhr.onload = function () {
    if (this.status === 200) {
        ...
        articles.forEach(function (element, index) {
            ...
            let news = `<div class="card ml-md-4 mt-4" style="width:300px; height:440px; background-color:skyblue;">
            ...
            <img class = "mt-4 mb-3 rounded" src = "${element["urlToImage"]}" alt = "image" width = "290px" height = "150px"/>
                                ...
                                <button class="btn btn-link " type="button" data-toggle="collapse" data-target="#collapse${index}"
                                   ...
                                   <b> Breaking News ${index + 1}: </b>  <p class="text-trucate">${element["title"]} </p> 
                                </button>
                                </div>  
                            </div>
